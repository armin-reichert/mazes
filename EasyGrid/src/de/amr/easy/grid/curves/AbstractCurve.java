 ...
 */
public abstract class AbstractCurve implements CellSequence {

	protected final Topology top;
	protected final List<Integer> dirs = new ArrayList<>();

	public AbstractCurve(Topology top) {
		this.top = top;
	}

	public AbstractCurve() {
		this(Topologies.TOP4);
	}
	...
	public IntStream stream() {
		return dirs.stream().mapToInt(Integer::intValue);
	}

	@Override
	public String toString() {
		return dirs.stream().map(dir -> top.getName(dir)).collect(joining("-"));
	}
